...
class Serviceetudiant
{
    ...
    {
        try {
            $requet = $this->db->prepare("SELECT etudiant.matricul as matricul,etudiant.nom as nom,
            etudiant.prenom as prenom,etudiant.email as email,etudiant.datenaissance as datenaissance,etudiant.tel as tel,
            type.libelle as libelle,type.montant as montant FROM etudiant ,type,boursier
    ...
    {
        try {
            $req=$this->db->prepare(" SELECT DISTINCT etudiant.matricul as matricul,etudiant.nom as nom,etudiant.prenom as prenom,etudiant.email as email,
