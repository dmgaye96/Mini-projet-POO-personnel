...
<body>
                    ...
                    <form class="col s12" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <i class="material-icons prefix">
                                    perm_identity</i>
                                <input  name="prenom" type="text" required class="validate">
                                <label for="Prenom">Prenom</label>
                            </div>
                            <div class="input-field col s6">
                                <i class="material-icons prefix">
                                    perm_identity</i>
                                <input name="nom" type="text" required class="validate">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input name="matricule" type="text" required class="validate">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <input name="date" type="date" required class="datepicker">
                                <label for="icon_prefix">Date de Naissance</label>
                            </div>
                            <div class="input-field col s6">
                                <i class="material-icons prefix">phone</i>
                                <input id="icon_telephone" type="tel" name="tel" required class="validate">
    ...
    if (isset($_POST['ajouter'])) {
        ...
        if (!empty($adresse)) {
            ...
            $cont->add($etudiant);
        } else if (!empty($id_type) && !empty($id_chambre))
